...
then
  C:/PROGRA~1/MINGW-~1/X86_64~1.0-P/mingw64/bin/mingw32-make.exe $targets_to_make ${EIGEN_MAKE_ARGS}
else
  C:/PROGRA~1/MINGW-~1/X86_64~1.0-P/mingw64/bin/mingw32-make.exe $targets_to_make 
fi
exit $?
