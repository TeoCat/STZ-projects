...
std::vector<cv::Rect> get_region_of_interest(const cv::Mat &original, const cv::Scalar& lover, const cv::Scalar& upper) {
...
void detect_text(const std::string& input) {
...
int main() {
    detect_text(std::string(R"(..\data\test_marker.jpg)"));
